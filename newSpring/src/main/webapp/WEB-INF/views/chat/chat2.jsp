...
<script type="text/javascript">
	...
	function wsOpen() {
		...
		var wsUri = "ws://" + location.host + "/springProject01/chating2";
	...
	function chatName() {
		...
		if (userName == null || userName.trim() == "") {
			...
			wsOpen();
			$("#meName").append(userName + '님 환영합니다!');
			$("#yourName").hide();
			$("#yourMsg").show();
		}
	}
...
<body>
	...
	<div id="container" class="container">
		 ...
		 ${pmjChatVO.p_title} 라이브톡
		<div id="meName"></div> <br>
